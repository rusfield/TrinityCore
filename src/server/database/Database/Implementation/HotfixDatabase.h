...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_CREATURE_DISPLAY_INFO_GEOSET_DATA,
    HOTFIX_SEL_CREATURE_DISPLAY_INFO_GEOSET_DATA_MAX_ID,
    ...
    HOTFIX_SEL_ITEM_DISPLAY_INFO_MODEL_MAT_RES,
    HOTFIX_SEL_ITEM_DISPLAY_INFO_MODEL_MAT_RES_MAX_ID,
